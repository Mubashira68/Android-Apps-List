package com.example.to_do_list.Adaptors;
...
import com.example.to_do_list.NotesClickListner;
...
public class NotesAdaptor extends RecyclerView.Adapter<NotesViewHolder> {
    ...
    public NotesAdaptor(Context context, List<Notes> list, NotesClickListner listner) {
    ...
    public NotesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NotesViewHolder(LayoutInflater.from(context).inflate(R.layout.sample_note, parent, false));
    }
...
class NotesViewHolder extends RecyclerView.ViewHolder {
    ...
    public NotesViewHolder(@NonNull View itemView) {
        ...
        textView_notes = itemView.findViewById(R.id.textViewNotes);
